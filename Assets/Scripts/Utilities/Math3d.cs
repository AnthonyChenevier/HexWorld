...
using UnityEngine;
/// <summary>
/// A class full of yummy 3d mathy goodness, courtesy of http://wiki.unity3d.com/index.php/3d_Math_functions.
/// Used under the provided Creative Commons Attribution Share Alike licence (http://creativecommons.org/licenses/by-sa/3.0/)
/// Not optimised to run a whole bunch of times per frame.
/// </summary>
public class Math3d
{
    ...
    /// </summary>
    /// <param name="gameObjectInOut"></param>
    /// <param name="alignWithVector"></param>
    /// <param name="alignWithNormal"></param>
    /// <param name="customForward"></param>
    /// <param name="customUp"></param>
    ...
    /// </summary>
    /// <param name="childRotation"></param>
    ...
    /// <param name="startChildRotation"></param>
    /// <param name="startChildPosition"></param>
    ...
    /// <param name="alignWithVector"></param>
    /// <param name="alignWithNormal"></param>
    /// <param name="alignWithPosition"></param>
    /// <param name="triangleForward"></param>
    /// <param name="triangleNormal"></param>
    /// <param name="trianglePosition"></param>
    ...
    /// <param name="rectC"></param>
    /// <param name="rectD"></param>
    /// <returns></returns>
