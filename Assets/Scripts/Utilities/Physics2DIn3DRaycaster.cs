...
namespace UnityEngine.EventSystems
{
    ...
    /// </summary>
    [AddComponentMenu("Event/Physics 2D in 3D Raycaster")]
    [RequireComponent(typeof(Camera))]
    public class Physics2DIn3DRaycaster : PhysicsRaycaster
    {
        protected Physics2DIn3DRaycaster() { }
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            {
                hits = Physics2D.RaycastAll(ray.origin, ray.direction, dist, finalEventMask);
            }
            else
            {
                hits = Physics2D.GetRayIntersectionAll(ray, dist, finalEventMask);
            }
